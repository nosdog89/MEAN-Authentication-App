...
var AuthService = (function () {
    ...
    AuthService.prototype.registerUser = function (user) {
        ...
        return this.http.post('http://127.0.0.1:3012/users/register', user, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    AuthService.prototype.authenticateUser = function (user) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('http://127.0.0.1:3012/users/authenticate', user, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    AuthService.prototype.getProfile = function () {
        ...
        headers.append('Content-Type', 'application/json');
        return this.http.get('http://127.0.0.1:3012/users/profile', { headers: headers })
            .map(function (res) { return res.json(); });
    };
